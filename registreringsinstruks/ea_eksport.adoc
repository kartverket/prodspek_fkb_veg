...
[discrete]
==== Tilleggsinformasjon for fotogrammetrisk registrering
Det presiseres at alle synlige vegbommer skal registreres fotogrammetrisk. Vegbommene registreres som om de er lukket/nedfelt, selv om bommen st&#229;r &#229;pen i bildene. Dette gjelder ogs&#229; ved planoverganger langs jernbane.
...
image::figurer/vegbom2_planovergang.png[link=figurer/vegbom2_planovergang.png, Alt="Illustrasjon av vegbom ved planovergang langs jernbane."]
